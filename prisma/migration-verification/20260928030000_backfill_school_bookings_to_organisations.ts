...
const verification: DataMigrationVerification = {
  migration: "20260928030000_backfill_school_bookings_to_organisations",
  intent:
        ...
        runs: [
          {
            ...
            scripts: [
              ...
              "20260928020000_booking_owner_optional_member",
            ],
            expectations: [
              {
                claim:
        ...
        mutants: [
          {
            ...
            script: "20260928030000_backfill_school_bookings_to_organisations",
        ...
        SELECT min(sm.member_id)
         ...
         WHERE sm.organisation_id = b."organisationId"
          ...
          },
          {
            ...
            script: "20260928020000_booking_owner_optional_member",
