...
**Current windowed migrations — there are five, and pending rows share ONE
...
6. **Run the safety validator, then migrate** — two commands, in that order. The
   ...
   `20260806010000`, and for programme #2912 `20260928010000`, `20260928020000`
   and `20260928030000` — including the additive rows; exact commands are in
