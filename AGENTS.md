...
| Taking, clearing, crediting or refunding money | `INV-PAY` → [`payment-and-settlement.md`](docs/invariants/payment-and-settlement.md) | [`xero/ARCHITECTURE.md`](docs/xero/ARCHITECTURE.md); [`design/booking-ledger.md`](docs/design/booking-ledger.md) for where the money columns are headed (#3532) |
...
- Gated areas (money movement, booking capacity, membership/family lifecycle,
  ...
  merge. This comment is the human gate agents check.
