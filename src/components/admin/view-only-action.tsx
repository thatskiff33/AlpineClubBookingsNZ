...
interface ViewOnlyActionButtonProps extends ButtonProps {
   ...
   * `describeReason={false}` here (261 of 348 call sites), and a further 34 pass
   ...
   *    counts 39 controls here, but that bucket is the arithmetic remainder,
