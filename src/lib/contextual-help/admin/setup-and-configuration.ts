    ...
    help(
      ...
      [
        ...
        },
        {
          ...
          description:
            "CURRENCY and LOCALE on the server seeded these once, and changing them no longer changes this setting - change it here. Do not remove them yet, and keep them matching your choice: every AMOUNT the site writes, and the dates outside the screens listed below, still come from the server values until the later stages of #3205 move them across.",
        },
        {
          name: "Last changed",
          description:
