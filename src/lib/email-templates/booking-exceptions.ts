...
export function bookingPolicyExceptionApprovedTemplate(args: {
  ...
  return layout(`
    ...
    ${infoTable([
      { label: "Check-in", value: emailClubDate(args.checkIn) },
      { label: "Check-out", value: emailClubDate(args.checkOut) },
...
export function hostingCoverageLostTemplate(data: {
  ...
  return layout(`
    ...
    ${infoTable([
      { label: "Check-in", value: escapeHtml(emailClubDate(data.checkIn)) },
      { label: "Check-out", value: escapeHtml(emailClubDate(data.checkOut)) },
