 ...
 * platform records every amount in the currency the club used when it was charged, and inventing a currency field here would be
 ...
 * sites at the source, so the census now reads 489 write sites and ZERO
