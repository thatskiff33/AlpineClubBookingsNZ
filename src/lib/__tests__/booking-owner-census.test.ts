...
const OWNERSHIP_COMPARISON_SITES: readonly string[] = [
  ...
  "src/app/api/bookings/[id]/guests/route.ts:323",
  ...
  "src/lib/booking-date-modification-service.ts:381",
  "src/lib/booking-delete.ts:121",
  "src/lib/booking-delete.ts:70",
  "src/lib/booking-email-authority.ts:115",
  "src/lib/booking-guest-removal-service.ts:433",
  "src/lib/booking-guest-removal-service.ts:769",
