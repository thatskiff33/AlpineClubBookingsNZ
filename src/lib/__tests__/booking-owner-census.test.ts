...
const OWNERSHIP_COMPARISON_SITES: readonly string[] = [
  ...
  "src/app/api/bookings/[id]/guests/route.ts:337",
  ...
  "src/lib/booking-batch-modification-service.ts:993",
...
const OPTIONAL_OWNER_READ_SITES: readonly string[] = [
  ...
  "src/lib/member-guest-consent-service.ts:1174",
...
const UNROOTED_ORGANISATION_SELECTIONS: readonly string[] = [
  ...
  "src/lib/payment-reconciliation.ts:87",
