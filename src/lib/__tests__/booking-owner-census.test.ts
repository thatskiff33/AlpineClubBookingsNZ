...
const OWNERSHIP_COMPARISON_SITES: readonly string[] = [
  ...
  "src/lib/booking-batch-modification-service.ts:996",
  "src/lib/booking-cancel.ts:486",
  ...
  "src/lib/booking-guest-removal-service.ts:452",
  "src/lib/booking-guest-removal-service.ts:788",
...
const OPTIONAL_OWNER_READ_SITES: readonly string[] = [
  ...
  "src/lib/member-guest-consent-service.ts:1184",
...
const UNROOTED_ORGANISATION_SELECTIONS: readonly string[] = [
  ...
  "src/lib/payment-reconciliation.ts:88",
  "src/lib/stuck-state-dashboard.ts:619",
  "src/lib/xero-booking-repair-types.ts:172",
  "src/lib/xero-inbound/invoice-paid-effects.ts:265",
];
