...
<<<<<<< HEAD
  `stripComments`, and since #3164 a lint rule enforces it.** 95 test files, three test
=======
  `stripComments`, and since #3164 a lint rule enforces it.** 95 test files, four test
>>>>>>> origin/main
