...
| `INV-SSOT-003` | An authority-bearing parameter carries no default; the mechanically-guarded class is a default reading the environment, and what is out of scope is stated rather than discovered |
