...
301 of the 354 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 301 split by WHICH rule
covers them: **267** pass the literal
