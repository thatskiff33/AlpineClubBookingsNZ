...
296 of the 349 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 296 split by WHICH rule
covers them: **262** pass the literal
