...
figures rather than trusting a hand count: **90 components render a banner, and
289 of the 342 `ViewOnlyActionButton` call sites opt out** of the per-button
...
covers them: **255** pass the literal
