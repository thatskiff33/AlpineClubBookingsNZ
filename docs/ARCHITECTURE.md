...
297 of the 350 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 297 split by WHICH rule
covers them: **263** pass the literal
