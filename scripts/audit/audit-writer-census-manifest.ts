...
export const AUDIT_CENSUS_TOTALS = {
  ...
  // request had existed.
  // 485 -> 486 (#3531 3b): `booking-payment.stored-night-price.rate-derived`,
  ...
  // beside the officer night-price repair it mirrors. MEASURED with
  // `npm run audit:census` on that branch.
  writeSites: 486,
  /**
